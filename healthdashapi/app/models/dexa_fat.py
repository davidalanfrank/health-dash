...
class DexaFat(models.Model):
    id = models.BigAutoField(primary_key=True)
    percentile_am = models.FloatField(null=True)
    percentile_yn = models.FloatField(null=True)
    ...
    class Meta:
        constraints = [
            models.PrimaryKeyConstraint(fields=['id'], name='dexa_fat_pkey'),
        ]
